...
//using TimsMod.Content.Rarities;
//using TimsMod.Content.Tiles.Furniture;
using System;
using Terraria;
using Terraria.ID;
...
namespace TimsMod.Content.Items.Weapons
{
    public class YoJohann : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 45; // The amount of damage the item does to an enemy or player.
            ...
            Item.shoot = ModContent.ProjectileType<YoJohannProjectile>();        // Which projectile this item will shoot. We set this to our corresponding projectile.
